...
(Funciones de generación de secuencias pseudoaleatorias.)
...
(Utilidades de búsqueda y ordenación.)
...
(Funciones de aritmética entera.)
...
(Funciones de conversión de carácter *multibyte*/ancho.)
...
(Funciones de conversión de *string* *multibyte*/ancho.)
